...
public class StorageController {
	...
	@PostMapping("/upload")
	public Object uploadFile(@RequestParam(value = "file") MultipartFile file, @RequestPart("saveDir") String saveDir) {
		return ResponseHandler.getResponse(service.uploadFile(file,saveDir), HttpStatus.OK);
	}
	
	@PostMapping("/upload-multiple-files")
	public Object uploadFile(@RequestParam(value = "files") MultipartFile[] files, @RequestPart("saveDir") String saveDir) {
